...
public class ErrorDetail {
    ...
    private java.util.Map<String, List<ValidationError>> errors = new HashMap<String, List<ValidationError>>();
    ...
    public java.util.Map<String, List<ValidationError>> getErrors()
    {
        return errors;
    }
